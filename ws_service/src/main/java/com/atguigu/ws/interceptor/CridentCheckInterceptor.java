...
public class CridentCheckInterceptor extends AbstractPhaseInterceptor<SoapMessage> {

	protected static Logger logger = Logger.getLogger(CridentCheckInterceptor.class); 
